...
// 新增 lastFetchedDistrict 來避免重複 request
const lastFetchedDistrict = ref(null);

// 新增 tooltip 資訊
const districtTooltip = ref(null);
async function fetchTooltip(district) {
	// 如果和上次一樣就不送 request
	if (lastFetchedDistrict.value === district) return;
	lastFetchedDistrict.value = district;

	district = district.slice(0, -1);
	districtTooltip.value = null;
	try {
		const response = await fetch(`/api/dev/tooltip/${district}`, {
			method: "GET",
			headers: { "Content-Type": "application/json" },
			credentials: "include",
		});
		const data = await response.json();
		districtTooltip.value = data.data;
	} catch (e) {
		districtTooltip.value = null;
	}
}
...
function toggleActive(e) {
	...
	if (targetDistrict.value) {
		fetchTooltip(targetDistrict.value);
	}
}
				...
				<g class="districtchart-chart-district-taipei">
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['新莊區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['淡水區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['汐止區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['板橋區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['三重區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['樹林區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['土城區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['蘆洲區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['中和區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['永和區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['新店區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['鶯歌區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['三峽區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['瑞芳區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['五股區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['泰山區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['林口區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['深坑區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['石碇區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['坪林區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['三芝區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['石門區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['八里區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['平溪區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['雙溪區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['貢寮區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['金山區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['萬里區'] / districtData.highest
							)
						"
						:fill="districtColor"
					...
					<path
						...
						:fill-opacity="
							Math.max(
								0.12,
								districtData['烏來區'] / districtData.highest
							)
						"
						:fill="districtColor"
			...
			<Teleport to="body">
				...
				>
					...
					<span>
						...
						{{ chart_config.unit }}
						<template v-if="districtTooltip">
							<div
								v-for="(val, key) in districtTooltip"
								:key="key"
							>
								{{ key }}：{{ val }}
							</div>
